...
{sidebarOpen && (
  ...
  />
      ...
      {/* Sidebar */}
      <div className={`ml-2 rounded-2xl fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${
